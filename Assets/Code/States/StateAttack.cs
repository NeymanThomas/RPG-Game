public class StateAttack
{
    ...
    public void Start_StateAttack() 
    {
        ...
        else 
        {
            ...
            CombatStateMachine.Instance.AnimationHandler.StartAttackAnimation(CombatStateMachine.Instance.CurrentCharacter.ActionList[CombatStateMachine.Instance.CurrentCharacterActionIndex].Name);
